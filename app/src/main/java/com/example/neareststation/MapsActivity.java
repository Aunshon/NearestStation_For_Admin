...
//        mMap.setTrafficEnabled(true);
        ...
        //mSearchText.setText(ConvertlatlongToPlace(latLngtoconvert));
        mdatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    ...
                    mMap.addMarker(new MarkerOptions().position(sydney).title(station.getAdd()));
                }
            }
    ...
    public void AddLocationBtn(View view) {
        ...
        alert.setMessage("Do You Want to Save a new station at --("+stationInfo.getAdd()+")-- Press Yes to save");
        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                //Toast.makeText(MapsActivity.this, "Yes", Toast.LENGTH_SHORT).show();
                mdatabaseRef.child(stationInfo.uploadId).setValue(stationInfo).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(MapsActivity.this, "Successfully Station Saved at "+stationInfo.getAdd(), Toast.LENGTH_SHORT).show();
                        onBackPressed();
                    }
    ...
    public void onBackPressed() {
        Intent mainint=new Intent(MapsActivity.this,MainActivity.class);
